...
[![Tests](https://github.com/terraform-cisco-modules/terraform-intersight-policies-device-connector/actions/workflows/terratest.yml/badge.svg)](https://github.com/terraform-cisco-modules/terraform-intersight-policies-device-connector/actions/workflows/terratest.yml)

# Terraform Intersight Policies - Device Connector
Manages Intersight Device Connector Policies

Location in GUI:
`Policies` » `Create Policy` » `Device Connector`
